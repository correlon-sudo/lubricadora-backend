...
exports.VentasModule = VentasModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [ventas_service_1.VentasService, venta_calculo_service_1.VentaCalculoService],
        exports: [ventas_service_1.VentasService, venta_calculo_service_1.VentaCalculoService],
    })
], VentasModule);
